...
-- Theming
local rofi_theme = "chiaro"
rofi_conf = "~/.config/rofi/themes/" .. rofi_theme .. ".rasi"
...
keys.globalkeys = gears.table.join(
    ...
    awful.key({ superkey },            "r",     
              function () 
                  awful.spawn.with_shell("rofi -modi run,drun -show drun -config " .. rofi_conf)
    ...
    awful.key({ superkey }, "z", function() naughty.destroy_all_notifications()                 end,
              {description = "dismiss notifications", group = "notifications"}),

    -- Volume Keys
    awful.key({}, "XF86AudioLowerVolume",
              pulse.volume_down,
              -- function() awful.spawn.with_shell("~/.local/bin/vol.sh -c down -i 5%") end,
              {description = "lower volume", group = "audio"}),
    awful.key({}, "XF86AudioRaiseVolume",
              -- function () awful.spawn.with_shell("~/.local/bin/vol.sh -c up -i 5%") end,
              pulse.volume_up,
              {description = "raise volume", group = "audio"}),
    awful.key({}, "XF86AudioMute",
              -- function () awful.spawn.with_shell("~/.local/bin/vol.sh -c mute") end,
              pulse.toggle_muted,
              {description = "mute/unmute volume", group = "audio"}),
    awful.key({}, "XF86AudioMicMute",
              pulse.toggle_muted_mic,
    ...
    awful.key({}, "XF86MonBrightnessUp", function ()
        awful.spawn.with_shell("xbacklight -inc 10")
              ...
              {description = "increase brightness", group = "power"}),
    awful.key({}, "XF86MonBrightnessDown", function ()
        awful.spawn.with_shell("xbacklight -dec 10")
    end,
              {description = "decrease brightness", group = "power"}),
    awful.key({}, "XF86Sleep", function ()
        -- works out of the box
        -- awful.spawn.with_shell("")
    end,
              {description = "go to sleep", group = "power"}),
    awful.key({}, "XF86ScreenSaver", function ()
        awful.spawn.with_shell("xset s activate")
    end,
              {description = "lock screen", group = "power"}),
    awful.key({}, "XF86PowerOff", function ()
        -- works out of the box (should a command tell everything to close nicely?)
        --awful.spawn.with_shell("")
    end,
...
keys.clientkeys = gears.table.join(
    ...
    awful.key({ superkey,           }, "`",      function (c) awful.titlebar.toggle(c)         end,
