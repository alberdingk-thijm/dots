...
beautiful.init(config .. "themes/" .. "gtk/theme.lua")
beautiful.wallpaper = "/home/tim/pictures/" .. "positron-dream/Torrent (Final).png"

-- Initialize power widget
-- FIXME: doesn't load fast enough
power = require("power_widget")
power:init()
